...
description: How to authenticate requests to the CRM Africa API.
---

# Authentication

Every CRM Africa API request is authenticated with an **API key**, sent as a Bearer token in the
